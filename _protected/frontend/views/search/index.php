...
<div class="search-index">
    ...
    <ul class="nav navs-tabs">
        <li role="presentation" class="active"><a href="<?= Url::to(['search/index', 'search'=>Html::encode($modelssearch)]); ?>">
                <?= Html::encode("บทความ") ?>
            </a>
        </li>
        ...
        <li role="presentation"><a href="<?= Url::to(['search/forum', 'search'=>Html::encode($modelssearch)]); ?>">
    ...
    <div class="col-lg-12 search">
       ...
       <?php endif; ?>
        ...
        <table class="table table-hover">
            <tr class="info">
                <td align="center">บทความ</td>
            </tr>
            <?php foreach ($models as $model): ?>
                <tr>
                    <td>
                        <a href="<?= Url::to(['article/showdetail', 'id'=>Html::encode($model->article_id)]); ?>">
